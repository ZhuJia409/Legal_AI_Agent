...
from app.schemas.contract_review import ReviewPerspective
from app.services.contract_review.persistence import ContractReviewSourceFile
from app.services.contract_review.types import ParsedRelatedDocument
from app.services.document_parser import DocumentParseError
from app.services.mineru_parser import DocumentParserProtocol, MineruParseResult

logger = logging.getLogger("legal_ai.api.contract_reviews.request_parsing")


def _document_parser_error_response(exc: DocumentParseError) -> JSONResponse:
    return document_parser_error_response(
        exc,
        parse_error_message="文档解析失败，请检查文件后重试。",
    )
